...
(function(window) {
	...
	var iChart_ = (function(window) {
		...
		_.apply(_, {
			...
			fixPixel : function(v) {
				return _.isNumber(v) ? v : pF(v.replace('%', "")) || 0;
			},
			toPixel : function(v) {
...
(function($) {
	...
	$.Chart = $.extend($.Painter, {
		...
		oneWay:function(_){
			...
			var E = _.variable.event,comb=_.Combination,tot=!_.get('turn_off_touchmove')&&!comb, mCSS = !$.touch&&_.get('default_mouseover_css')&&!comb, O, AO,events = $.touch?['click','click']:['click','mousemove'];
			_.stopEvent = false;
